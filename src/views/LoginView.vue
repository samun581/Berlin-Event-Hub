...
<template>
  <main class="auth-page">
    <section class="auth-card">
      ...
      <p v-if="route.query.reason === 'session-expired'" class="message info">Your session has expired. Please log in again.</p>
      <p v-if="route.query.reason === 'password-changed'" class="message success">Password changed successfully. Please log in with your new password.</p>
